...
// config file
static const size_t MAX_REQUEST_LINE = static_cast<const size_t>(8 * 1024); // 8kb
static const size_t MAX_HEADER_FIELD = static_cast<const size_t>(4 * 1024); // 4kb
